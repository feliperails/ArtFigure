...
Camera::Camera(Display* display) {
	...
	this->lastX = this->display->getWidth() / 2.0;
	this->lastY = this->display->getHeight() / 2.0;
...
void Camera::initCamera(glm::vec3 position, glm::vec3 up, GLfloat yaw, GLfloat pitch)
{
...
void Camera::initCamera(GLfloat posX, GLfloat posY, GLfloat posZ, GLfloat upX, GLfloat upY, GLfloat upZ, GLfloat yaw, GLfloat pitch)
{
	this->front = glm::vec3(0.0f, 0.0f, -1.0f);
	this->movementSpeed = SPEED;
	this->mouseSensitivity = SENSITIVTY;
