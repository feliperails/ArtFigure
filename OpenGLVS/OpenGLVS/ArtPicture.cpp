...
void ArtPicture::build()
{
	...
	for (ArmPart* &part : parts)
	{
		...
		GLfloat verticesData[] =
		{
			...
			part->getSize(), 0.0f, 0.0f, color[0], color[1], color[2], color[3],
			part->getSize(), 0.5f, 0.0f, color[0], color[1], color[2], color[3],
			part->getSize(), 0.5f, 0.0f, color[0], color[1], color[2], color[3],
			0.0f,			 0.5f, 0.0f, color[0], color[1], color[2], color[3],
			0.0f,			 0.0f, 0.0f, color[0], color[1], color[2], color[3]
		};
